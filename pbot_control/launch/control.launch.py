...
def generate_launch_description():
    ...
    # Configs
    config_pbot_ekf = PathJoinSubstitution(
        [FindPackageShare('pbot_control'),
         'config',
         'localization.yaml'],
    )
    ...
    config_pbot_velocity_controller = PathJoinSubstitution(
        [FindPackageShare('pbot_control'),
        'config',
        'jackal_base_control.yaml'],
    )
    ...
    control_group_action = GroupAction([
        ...
        Node(
            ...
            parameters=[{'robot_description': robot_description_content},
                        config_pbot_velocity_controller],
            output={
                'stdout': 'screen',
                'stderr': 'screen',
            },
